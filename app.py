...
각 항목은 [제목] 하나로 시작하고 바로 아래에 내용을 이어 쓰시오.
제목은 이 사람의 일간·오행·사주 특성을 반영한 짧고 인상적인 문구로 직접 지어 쓰시오. 번호나 카테고리명은 쓰지 마시오.
예) [庚金의 칼날 같은 본성], [흙 속에 묻힌 황금 재물운], [火의 기운이 이끄는 천직] 이런 식으로.
별표(**), 이모지, 구분선, 목록 기호, 소제목은 절대 쓰지 마시오.
한자가 등장할 때만 괄호 안에 한글 독음을 병기하시오. 예) 庚金(경금)
이미 한국어인 단어에는 절대 괄호를 달지 마시오. 사주, 오행, 재물, 운세 같은 단어 뒤에 같은 뜻 한국어를 괄호로 반복하는 것은 금지이오.
명리학 전문 용어가 처음 등장할 때만 짧게 뜻풀이 하시오. 이미 설명한 용어는 다시 풀지 마시오.
각 항목의 내용이 서로 겹치지 않도록 하시오.
인공지능, AI, 데이터, 알고리즘 같은 단어는 절대 쓰지 마시오.

아래 6가지 영역을 순서대로, 각각 사주에 어울리는 제목을 붙여 작성하시오.
...
두 번째 항목 — 재물 및 경제운
정재(꾸준히 벌어들이는 돈)와 편재(한번에 크게 들어오는 돈)의 비율로 본 재물 그릇과 축재 방식을 서술하시오.
공격적 투자와 안정적 저축 중 이 사주에 맞는 방향을 근거와 함께 서술하시오.
돈이 강하게 들어오는 시기와 지출을 단속해야 하는 시기, 평생 재물운의 큰 흐름을 서술하시오.

세 번째 항목 — 직업 및 커리어
관성(직업·사회적 지위 기운)과 식상(재능·표현력 기운)으로 본 천직과 유리한 산업군을 구체적으로 서술하시오.
직장 생활과 사업 중 어느 쪽이 맞는지, 상사·동료와의 처세, 승진운을 짚으시오.
이직이나 창업 등 변화에 가장 좋은 시기를 서술하시오.

네 번째 항목 — 애정 및 인간관계
내가 끌리는 사람과 나에게 잘해주는 사람의 차이, 연애에서 반복되는 패턴을 서술하시오.
배우자성이 어디에 자리하는지, 인연이 나타나는 시기와 잘 맞는 상대의 오행·일간을 서술하시오.
결혼 후 가정운, 갈등이 생기기 쉬운 살(煞)·합(合) 관계와 개선 조언을 서술하시오.

다섯 번째 항목 — 건강 및 라이프스타일
...
2026년 병오년이 이 사주에 미치는 영향과 올해 행동 지침을 짚으시오.
중요한 결정을 내리기에 가장 길한 골든타임이 언제인지 서술하시오.
