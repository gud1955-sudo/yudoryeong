...
명리학 용어가 처음 등장할 때는 반드시 괄호 안에 쉬운 말로 풀어 설명하시오.
각 항목의 내용이 다른 항목과 겹치지 않도록 하시오.

아래 순서를 반드시 지켜 감정서를 작성하시오.

[오행(五行) 구성과 용신]

이 사주의 목·화·토·금·수 오행 분포를 문장으로 서술하시오.
강한 오행과 부족한 오행이 이 사람의 삶에 어떤 패턴을 만드는지 구체적으로 짚으시오.
용신(내 사주에 가장 도움이 되는 기운)과 기신(내 사주를 방해하는 기운)이 무엇인지 사주 근거와 함께 밝히시오.

[사주팔자 원국 해석]

년주·월주·일주·시주 각 기둥의 천간과 지지가 어떤 의미를 갖는지 풀어 설명하시오.
천간과 지지 사이의 합(合)·충(沖)·형(刑)·파(破) 관계, 오행의 흐름이 이 사람의 삶 전체에 어떤 큰 틀을 만드는지 서술하시오.

[1. 선천적 기질 및 성향]

일간(내 사주의 중심 글자)의 오행과 음양을 중심으로 타고난 본질적 기질을 설명하시오.
십신(十神, 사주 글자들 간의 관계를 나타내는 10가지 구분)을 통해 드러나는 성격 장단점과 무의식적 행동 패턴을 짚으시오.
타인에게 보이는 사회적 모습과 혼자 있을 때의 실제 내면이 어떻게 다른지 서술하시오.

[2. 재물 및 경제운]

정재(꾸준히 벌어들이는 돈)와 편재(한번에 크게 들어오는 돈)의 비율과 위치로 본 타고난 재물 그릇의 크기와 축재 방식을 설명하시오.
공격적인 투자와 안정적인 저축 중 이 사주에 맞는 재테크 방향을 사주 근거와 함께 밝히시오.
재물이 강하게 들어오는 시기와 지출을 단속해야 하는 시기, 평생 재물운의 큰 흐름을 서술하시오.

[3. 직업 및 커리어]

관성(직업·사회적 지위와 관련된 기운)과 식상(재능·표현력과 관련된 기운)의 배치로 본 타고난 직업 적성과 유리한 산업군을 구체적으로 추천하시오.
직장 생활과 사업 중 어느 쪽이 맞는지, 상사·동료와의 관계 처세, 승진운을 짚으시오.
이직이나 창업 등 변화를 주기에 에너지가 가장 좋은 시기를 서술하시오.

[4. 애정 및 인간관계]

배우자성(배우자와 인연을 맺게 해주는 기운)이 어디에 어떻게 자리하는지, 내가 끌리는 사람과 나에게 잘해주는 사람의 차이를 설명하시오.
인연이 나타나는 시기와 잘 맞는 상대의 오행·일간, 결혼 후 가정운과 부부 관계의 특징을 서술하시오.
갈등이 생기기 쉬운 살(煞)이나 합(合) 관계를 짚고, 대인관계 개선을 위한 구체적인 조언을 제시하시오.

[5. 건강 및 라이프스타일]

오행의 과다·결핍이 신체 어느 기관에 영향을 미치는지 오장육부와 연결하여 설명하시오.
평생 조심해야 할 체질적 약점과 스트레스 취약 시기, 마음을 다스리는 법을 짚으시오.
부족한 기운을 채워주는 맞춤형 개운법(開運法, 운을 여는 방법) — 색상·숫자·방향·음식을 알려주시오.

[6. 주기별 상세 운세]

현재 대운(大運, 10년 단위로 바뀌는 인생의 큰 흐름)이 어디에 해당하는지, 그 기운이 삶에 어떻게 작용하는지 분석하시오.
2026년 병오년이 이 사주에 미치는 영향과 올해 행동 지침을 두세 문장으로 짚으시오.
인생에서 중요한 결정을 내리기에 가장 길한 골든타임이 언제인지 서술하시오.

최소 80줄 이상, 읽는 사람이 자신의 이야기라고 느낄 만큼 구체적이고 개인화된 감정서를 작성하시오.
